      ...
      >
        ...
        <View style={styles.textContainer}>
          {ENVIRONMENT_NAME !== "production" && (
            <AppText
              text={`${ENVIRONMENT_NAME}. ${getDefaultRedirectUri()}. Version 2.4. Login a sint oluptatiur nusa doluptatem Occatur ulparcia es pro que in pa doloren imaios recescid et, quo doloria nis dellabore dolut hilla dit pos quidia volecto beatempero dolent.  Ut omnit, sam et ex ex exero.`}
            />
          )}
        </View>
      </MainContentArea>
